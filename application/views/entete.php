  ...
  <div class="container">
    ...
    <header class="row">
      ...
      <div class="col-md-5 col-lg-4">
        <img src="<?=base_url('assets\images\jarditou_photos\jarditou_logo.jpg')?>" class="img-fluid"
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent15">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="<?=site_url('produits/index')?>">Accueil <span
                class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?=site_url('produits/liste')?>">Tableau</a>
          </li>
          <li class="nav-item">
        ...
        if(isset($this->session->admin))
        {
            ?>
          <li class="nav-item">
            <a class="nav-link" href="<?=site_url('produits/ajout_produit')?>">Ajouter un produit</a></li>
          <?php
        }
        ?>
        </ul>
        ...
        ?>
          <li class="nav-item mt-2">
            <a class="nav-link" href="<?=site_url('produits/form_connexion')?>">Connexion</a>
          </li>
          <?php
        }
      ?>
    ...
    <div class="row">
      <img src="<?=base_url('assets\images\jarditou_photos\promotion.jpg')?>" id="image"
